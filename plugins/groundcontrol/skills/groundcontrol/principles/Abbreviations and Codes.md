...
## Abbreviations  
Abbreviations are a shortened form of a word used in the annotation.  
Eg SYM is short for SYMMETRICAL  
'Codes' should not be confused with 'abbreviations'.  

## Codes  
Codes provide a link between a detail, a long description on the [[A00 - Introductory documents]] legend sheet and the full description in the specification.
...
| -------------- | ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AM-1, AM-2 | ARCHITECTURAL METALWORK | Brief architectural description of sundry metalwork items, e.g. GALVANISED STEEL GRATING STAIRS AND PLATFORM |
...
| BLK-1, BLK-2 | BLOCKWORK | Description of different types of concrete masonry units, e.g. 290mm CORE FILLED FACE QUALITY CONCRETE BLOCK |
...
| BRD-1, BRD-2 | SHEET MATERIALS | Various types of boards used – medium density fibreboard, plywood, chipboard and similar, e.g. 1 mm PLYWOOD |
...
| COL-1, COL-2… | COLOUR | Colour codes used to identify specific colours across the project. Full description (manufacturer reference and colour name) in A80 Colour Schedule. E.g. COL-1 = Dulux Natural White Half Strength. Combined with a PT code on drawings and schedules: PT1/COL-1. See [[Tagging of Elements in ArchiCAD]]. |
...
| P1, P2 | PARTITIONS | To make the best use of limited space within the partition symbol, break codes into groups: P1, P2 = common plasterboard partitions; A1, A2 = acoustically rated partitions; F1, F2 = fire rated partitions; G1, G2 = internal windows and glazed partitions; L1, L2 = partitions lined from one side only, etc. |
...
| PT1, PT2… | PAINTS | Paint system codes — each code identifies a complete paint system (product type, sheen, coats, prep) described in full in the Z Specification. One PT code per system regardless of substrate. Do not include colour in the PT code description — colour is carried separately using COL codes. Combined on drawings and schedules as PT/COL, e.g. PT1/COL-4. See [[Tagging of Elements in ArchiCAD]]. |
