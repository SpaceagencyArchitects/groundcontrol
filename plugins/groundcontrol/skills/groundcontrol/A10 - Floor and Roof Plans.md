...
**A100-A149**
**A10.## (LEVEL)** (use if each level fits on a single sheet or for overall GA plans)
**A11.##.## (LEVEL.SEQUENCE)** (use if each level is broken into sectors or stages or if showing areas of the plan at a larger scale)
...
- Windows and external doors horizontal dimensional setting-out - offsets from grid lines only (See A20 - External Elevations and A70 - Doors and Windows for windows description)  
