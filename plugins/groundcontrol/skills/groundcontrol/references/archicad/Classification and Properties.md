...
References:
[Properties and Classification Systems](https://help.graphisoft.com/AC/29/INT/index.htm?rhcsh=1&rhnewwnd=0&rhmapid=#t=_AC29_Help%2F045_PropertiesClassifications%2F045_PropertiesClassifications-1.htm&rhsearch=classification&rhsyns=%20&rhhlterm=classification)

## ALL ELEMENTS

### Set Classification:
Tick 'SpA Classification - v1.0' and choose a classification from the dropdown list. 
...
**KEYNOTE Code:** 
This property is available to all elements that have been classified under 'ARCHICAD Classification - v 2.1'. The Code is the part of the name of the complex profile or composite attribute placed in square brackets. 
