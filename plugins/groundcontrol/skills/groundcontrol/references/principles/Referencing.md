...
## One Way Referencing  
Always reference from a larger scale drawing to a more detailed-one, e.g. from **1:100** floor plan in [[A10 - Floor and Roof Plans]] to corresponding **1:50** plan in [[A60 - Internal Spaces (Room Layouts)]].  
  
Always reference 'one step at a time'. For instance, make reference to **1:10** detail of a joinery item in [[A65 - Joinery]], only from [[A60 - Internal Spaces (Room Layouts)]]. Do not draw 'a box within a box' in [[A10 - Floor and Roof Plans]].  
