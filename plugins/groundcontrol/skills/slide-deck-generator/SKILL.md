...
A sample deck demonstrating every type is at `~/.claude/skills/slide-deck-generator/sample.html`.
...
4. **Write the HTML file.** Use the template below as the foundation. Customize only the slide content inside `<body>`.
